...
public class Application extends MultiThreadedApplicationAdapter implements IStreamListener {
	...
	public boolean appStart(IScope scope) {
		...
		output = new ICYStream("cpplus");

		output.setScope(scope);

		input = new Cptest(output);
		...
		streamer.setHost("172.16.0.177");
		streamer.setPort(1935);
		streamer.start("cpplusrecord" + System.currentTimeMillis() / 1000, "record", new Object[] {});
